...
int gvcart_loaddata_(int * filename_len,
    ...
    for (int i = 0; i < nobs; i++) {
        ...
        switch (obs[i].type) {
            ...
            /*  We don't really have the equivalent of "tide" measurements in our problem
            case TIDE_OBS:
                //
            ...
            */
            ...
            case CS2_FREEBOARD_OBS:
                n = 2;
                // We will start for just these two parameters right?
                mi[0] = SNOW_MODEL;
                mi[1] = ICE_MODEL; 
...
int gvcart_compute_prediction_(int * nmodels,
    ...
    switch (obs[ * observation].type) {
        ...
        /* We don't really have the equivalent of tide measurements in our problem so we can get rid of this
