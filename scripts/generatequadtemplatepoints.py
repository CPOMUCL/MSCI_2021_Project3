...
if __name__ == '__main__':
    ...
    parser.add_argument('-C', '--observations-C', type = int, default = 50, help = 'No. C observations')
    parser.add_argument('-D', '--observations-D', type = int, default = 50, help = 'No. D observations')
    ...
    N = args.observations_A + args.observations_B + args.observations_C + args.observations_D
    ...
    for i in range(args.observations_C):
    ...
    for i in range(args.observations_D):
